...
> **![FinAgent Dashboard](./docs/assets/dashboard.png)**
> **![FinAgent Chart Vision](./docs/assets/chart_vision.png)**
...
This repository ships with full Google Cloud Build automation via `app/main.py`. The backend is containerized via `Dockerfile` and actively deployed on Google Cloud Run leveraging Google Cloud network services to ensure worldwide seamless market data flow without local rate limits.
